...
qa_assert_contains "size-report.json" "18-qa:size-report"
qa_assert_contains "sizereport.missing" "18-qa:size-report-missing-finding"
qa_assert_contains "sizereport.suspicious-size" "18-qa:size-report-suspicious-finding"
