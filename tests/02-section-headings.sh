...
assert_contains_regex '^## Conversion$' "02-headings:conversion"
assert_contains_regex '^## Visual design$' "02-headings:visual"
assert_contains_regex '^## Voice$' "02-headings:voice"
assert_contains_regex '^## Content variation policy$' "02-headings:content-variation"
